    ...
    $.fn.cycle.transitions.carousel = {
        ...
        postInit: function (opts) {
            ...
            if (opts.allowWrap !== false) {
                ...
                for (
                    j = 0;
                    j < (opts.carouselVisible === undefined ? 2 : 1);
                    j++
                ) {
                ...
                wrap.find(".cycle-slide-active").removeClass(
                    "cycle-slide-active"
                );
                opts.slides
                    .eq(opts.startingSlide)
        ...
        prepareDimensions: function (opts) {
            ...
            if (opts.carouselFluid && opts.carouselVisible) {
                ...
                dim =
                    visCount *
                    $(opts.slides[0])[vert ? "outerHeight" : "outerWidth"](
                        true
                    );
                opts.container[vert ? "height" : "width"](dim);
            }
            ...
            if (opts.allowWrap !== false) {
                if (opts.carouselSlideDimension) {
                    offset -=
                        ...
                        opts.carouselSlideDimension;
                } else {
                    // calculate offset based on actual slide dimensions
                    tmp = opts._carouselWrap.children();
                    for (j = 0; j < opts.slideCount + opts.currSlide; j++) {
                        offset -= $(tmp[j])[
                            vert ? "outerHeight" : "outerWidth"
                        ](true);
                    }
                }
            }
        ...
        transition: function (opts, curr, next, fwd, callback) {
            ...
            if (opts.allowWrap === false) {
                ...
                if (
                    ...
                    hops =
                        opts.nextSlide - currSlide - (opts.nextSlide - maxCurr);
                } else if (
                    hops < 0 &&
        ...
        genCallback: function (opts, fwd, vert, callback) {
            ...
            return function () {
                ...
                opts._carouselWrap.css(
                    opts.carouselVertical ? "top" : "left",
                    offset
                );
                callback();
            };
