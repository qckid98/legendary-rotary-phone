        ...
        pause: function (hover) {
            ...
            if (!alreadyPaused) {
                ...
                if (slideOpts.timeout) {
                    ...
                    if (
                        opts._remainingTimeout < 0 ||
                        isNaN(opts._remainingTimeout)
                    )
...
(function ($) {
    ...
    function initAutoHeight(e, opts) {
        ...
        if (autoHeight == "container") {
            ...
            opts.container.height(
                opts.container.width() / opts._autoHeightRatio
            );
        } else if (
            autoHeight === "calc" ||
        ...
        function (e, opts, slideOpts, currSlide) {
            ...
            $.each(["caption", "overlay"], function () {
                ...
                if (el.length && template) {
                    el.html(
                        opts.API.tmpl(template, slideOpts, opts, currSlide)
                    );
                    el.show();
                } else {
                    el.hide();
